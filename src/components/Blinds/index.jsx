    ...
    return (
        <div className="blinds">
				...
				<div className="blinds__controls">
					<button className={ stateBlinds === 'open' ? "button button--active" : "button" } onClick={ handleClick }>Otevřeno</button>
					<button className={ stateBlinds === 'open' ? "button" : "button button--active" } onClick={ handleClick }>Zavřeno</button>
				</div>
			</div>
    )
}
